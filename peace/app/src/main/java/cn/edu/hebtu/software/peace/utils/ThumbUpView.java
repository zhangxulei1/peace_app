...
public class ThumbUpView extends View {
    ...
    private float loveSize = 0.5f;

    private LikeType mUnLikeType = LikeType.broken;
    private int edgeColor = Color.rgb(205,201,201);
    private int fillColor = Color.rgb(222, 106, 106);
    ...
    private void init(AttributeSet attrs) {
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, com.ldoublem.thumbUplib.R.styleable.ThumbUpView);
        if (typedArray != null) {
            edgeColor = typedArray.getColor(com.ldoublem.thumbUplib.R.styleable.ThumbUpView_edgeColor, edgeColor);
            fillColor = typedArray.getColor(com.ldoublem.thumbUplib.R.styleable.ThumbUpView_fillColor, fillColor);
            cracksColor = typedArray.getColor(com.ldoublem.thumbUplib.R.styleable.ThumbUpView_cracksColor, cracksColor);
            bgColor = typedArray.getColor(com.ldoublem.thumbUplib.R.styleable.ThumbUpView_bgColor, bgColor);

            int type = typedArray.getInteger(com.ldoublem.thumbUplib.R.styleable.ThumbUpView_unlikeType, 0);
