...
public class WaveBezierView2 extends View {
    ...
    public WaveBezierView2(Context context) {
        super(context);
    }

    public WaveBezierView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public WaveBezierView2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
