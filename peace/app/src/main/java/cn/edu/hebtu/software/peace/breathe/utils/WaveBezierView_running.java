...
public class WaveBezierView_running extends View {
    ...
    public WaveBezierView_running(Context context) {
        super(context);
    }

    public WaveBezierView_running(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public WaveBezierView_running(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
