...
public class WaveFunctionView2 extends View {
...
private float waveDeep = 20f;//波峰与波谷
    ...
    public WaveFunctionView2(Context context) {
        super(context);
        init();
    }

    public WaveFunctionView2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public WaveFunctionView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
