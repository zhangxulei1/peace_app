...
public class WaveBezierView_running2 extends View {
    ...
    private float waveTop = 80f;//波峰值
    private float waveDeep = 80f;//波谷值
    ...
    private int percent = 7;//波的水位百分比，0~10,这里为70%

    public WaveBezierView_running2(Context context) {
        super(context);
    }

    public WaveBezierView_running2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public WaveBezierView_running2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
