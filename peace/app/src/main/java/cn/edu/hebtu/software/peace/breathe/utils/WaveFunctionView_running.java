...
public class WaveFunctionView_running extends View {
...
private float waveDeep = 20f;//波峰与波谷
    ...
    public String MAINCOLOR_DEF = "#BCD2EE", NEXTCOLOR_DEF = "#B9D3EE";//默认颜色
    ...
    public WaveFunctionView_running(Context context) {
        super(context);
        init();
    }

    public WaveFunctionView_running(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public WaveFunctionView_running(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void ChangeWaveLevel(int percent) {
        ...
        animatorh.setDuration(5000);//设置动画时间
